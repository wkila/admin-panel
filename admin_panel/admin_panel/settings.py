...
SUB_DIR = Path(__file__).resolve().parent.parent.parent
...
SECRET_KEY = 'django-insecure-rn7tk$v)!zzh+y=x)&^!xwdxou#m&6dtojl&4rgcqour$h&s^4'
...
# Папка, куда будут собираться все статические файлы при выполнении collectstatic
